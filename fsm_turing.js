...
document.getElementById("btnprobarCadenaTuring").onclick = function() {probarTuring()};
	...
	canvas.ondblclick = function(e) {
		...
		if(selectedObject == null) {
			...
			if(selectedObject.isAcceptState == false){
				if(selectedObject.isRejectState == false){
					selectedObject.isAcceptState = !selectedObject.isAcceptState;
					draw();
					console.log("shit");
				}
				else if(selectedObject.isRejectState == true){
					selectedObject.isRejectState = !selectedObject.isRejectState;
				}
			}
			else if(selectedObject.isAcceptState == true){
				if(selectedObject.isRejectState == false){
					selectedObject.isAcceptState = !selectedObject.isAcceptState;
					selectedObject.isRejectState = !selectedObject.isRejectState;
					draw();
